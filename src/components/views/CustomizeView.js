...
export class CustomizeView extends LitElement {
    ...
    async handleCustomPromptInput(e) {
        ...
        await assistant.storage.updatePreference('customPrompt', e.target.value);
    }

    async handleAudioModeSelect(e) {
        this.audioMode = e.target.value;
        await assistant.storage.updatePreference('audioMode', e.target.value);
        this.requestUpdate();
    }

    async handleThemeChange(e) {
        this.theme = e.target.value;
        await assistant.theme.save(this.theme);
    ...
    async clearLocalData() {
        ...
        try {
            await assistant.storage.clearAllData();
    ...
    async handleBackgroundTransparencyChange(e) {
        ...
        await assistant.storage.updatePreference('backgroundTransparency', this.backgroundTransparency);
        this.updateBackgroundAppearance();
        this.requestUpdate();
    }
    ...
    updateBackgroundAppearance() {
        ...
        const colors = assistant.theme.get(this.theme);
        assistant.theme.applyBackgrounds(colors.background, this.backgroundTransparency);
    }
    ...
    async handleFontSizeChange(e) {
        ...
        await assistant.storage.updatePreference('fontSize', this.fontSize);
        this.updateFontSize();
        this.requestUpdate();
    }
